...
export const GAME_DB: Game[] = [
    ...
    { id: "DR_C10", theme: "회식·술자리", type: "C", timeSec: 10, prompt: "종류", A: "하이볼", B: "막걸리" },
    { id: "DR_C11", theme: "회식·술자리", type: "C", timeSec: 10, prompt: "안주2", A: "치킨", B: "삼겹살" },
    { id: "DR_C12", theme: "회식·술자리", type: "C", timeSec: 10, prompt: "게임", A: "눈치", B: "랜덤" },
    { id: "DR_C13", theme: "회식·술자리", type: "C", timeSec: 10, prompt: "토크", A: "추억", B: "밈톡" },
    { id: "DR_C14", theme: "회식·술자리", type: "C", timeSec: 10, prompt: "마무리", A: "해장", B: "디저트" },
    { id: "DR_C15", theme: "회식·술자리", type: "C", timeSec: 10, prompt: "3차", A: "간다", B: "안 간다" },
    { id: "DR_C16", theme: "회식·술자리", type: "C", timeSec: 10, prompt: "주도", A: "내가", B: "상대" },
    { id: "DR_C17", theme: "회식·술자리", type: "C", timeSec: 10, prompt: "사진", A: "남김", B: "안 남김" },
    ...
    { id: "CR_C04", theme: "크루모드", type: "C", timeSec: 10, prompt: "피드백", A: "직설", B: "부드럽게" },
    ...
    { id: "CR_C11", theme: "크루모드", type: "C", timeSec: 10, prompt: "칭찬", A: "공개", B: "비공개" },
    { id: "CR_C12", theme: "크루모드", type: "C", timeSec: 10, prompt: "협업", A: "주도", B: "지원" },
    { id: "CR_C13", theme: "크루모드", type: "C", timeSec: 10, prompt: "결정", A: "빠름", B: "신중" },
    { id: "CR_C14", theme: "크루모드", type: "C", timeSec: 10, prompt: "문서", A: "짧게", B: "자세히" },
